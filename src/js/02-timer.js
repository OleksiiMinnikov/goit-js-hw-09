...
// Встановлення атрибуту "disabled" для кнопки "Start"
startBtn.setAttribute('disabled', true);

// Функція для конвертації мілісекунд у об'єкт з днями, годинами, хвилинами та секундами
...
// Функція для додавання ведучих нулів до значення
...
// Ініціалізація flatpickr з використанням опцій
